	...
	public void setup() throws PathException {
		...
		input = new PlannerInput() {
			...
			public Thing[] getObjects() {
				return new Thing[] { tmp, path, predicate };
			}
			...
			@Override
			public Goal getGoal() {
				return new GoalImpl(new Fact[] { new BasicFact(new HasSlice(), tmp, uncle) });
			}
			...
			public Operator[] getOperators() {
				return new Operator[] { new Shortcut(), new Link(), new Renew() };
			}
		};
	}
